...
object InvariantFunctors {
  ...
  implicit val optionCryptoDouble: Crypto[Option[Double]] = caesarCypher.imap(_.toString, a => Option(a.toDouble))
  ...
  def main(args: Array[String]): Unit = {
    ...
    println(decrypt[Option[String]](encrypted)) // Some(Lets encrypt)
